...
from app.api.elections.models import election, election_response, election_full_model, election_user_response_model,  election_full_response_model, election_full_response_model_
...
class ElectionList(Resource):
    ...
    @namespace.marshal_list_with(election_full_response_model_)
    @namespace.response(200, 'Success', election_full_response_model_)
    def get(self):
        """
        Get all elections.
        """
