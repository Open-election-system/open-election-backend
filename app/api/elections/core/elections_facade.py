...
class ElectionsFacade:
    ...
    def get_elections(user_id):
        ...
        available_restrictions = container.restrictions_service.get_by_params(user_info)
        for restriction in available_restrictions:
            election = container.elections_service.get_by_params(restriction.id)
    ...
    def get_election(election_id, user_id):
        election_item = container.elections_service.get_by_id(election_id)
        restrictions = container.restrictions_service.get_by_id(election_item.restrictions_id)
